...
void file_rw::file_write_vec(std::string file_name, std::vector< std::vector<double> > vec)
{
...
void file_rw::file_write_mat(std::string file_name, Eigen::MatrixXd mat)
{
    std::ofstream out_file;
    out_file.open(file_name.c_str(),std::ios::out);
...
void file_rw::file_write_mat(std::string file_name, Eigen::MatrixXi mat)
{
    std::ofstream out_file;
    out_file.open(file_name.c_str(),std::ios::out);
    for (long i=0;i<mat.rows();++i)
