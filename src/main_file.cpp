...
int main()
{
	...
	bool generate_cont_toolpath = false;		// add start and end point for each layer
	...
	Eigen::MatrixXd f;
	Eigen::MatrixXd n;
	std::string stl_file_name = "/home/aniruddha/Desktop/Non_Planar_3D_Printing/CPP/data/test_part2.STL";
	...
	std::vector<std::vector<double> > view_pts = ut::mat_to_vec(tool_path);
	// gp << "set xrange [0:200]\n";
	// gp << "set yrange [0:200]\n";
	// gp << "set zrange [0:200]\n";
